@extends('frontend.userdashboardlayouts.main')
@section('main-container')
			...
			<div class="add2">
                ...
                <form class="row g-3" action="{{ url('/') }}/student_update" method="post">
    ...
    <span class="text-danger"> 
      ...
      @enderror
        ...
        <button type="submit" class="btn btn-primary btn1">Update</button>
    </form>
