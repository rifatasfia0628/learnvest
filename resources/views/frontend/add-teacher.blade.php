...
<div class="add">
    ...
    <form class="row g-3" action="{{ url('/') }}/add_teacher" method="post">
  ...
  <div class="col-md-6">
    ...
    <div class="col-md-6 sec">
      <label for="inputsemester" class="form-label">Supervised Semester</label>
  ...
  @enderror
   ...
   <div class="col-md-6 sec">
      <label for="inputsection" class="form-label">Supervised Section</label>
...
<div class="col-md-6 sec">
      <label for="inputCareer" class="form-label">Career Supervision</label>
...
<div class="col-md-6 sec">
    <button type="submit" class="btn btn-primary btn1">Add Teacher</button></div>
</form>
